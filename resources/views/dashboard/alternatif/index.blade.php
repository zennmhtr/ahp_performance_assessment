                ...
                <div class="modal-box">
                    <form action="{{ route('alternatif.simpan') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-action">
                            ...
                            <label for="add_button" class="btn">Cancel</label>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal">
                <div class="modal-box" id="edit_form">
                    <form action="{{ route('kriteria.perbarui') }}" method="post" enctype="multipart/form-data">
                        <h3 class="font-bold text-lg">Ubah Nama Karyawan: <span class="text-greenPrimary" id="title_form"><span class="loading loading-dots loading-md"></span></span></h3>
                            @csrf
                        ...
                        <div class="modal-action">
                            ...
                            <label for="edit_button" class="btn">Cancel</label>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal">
                <div class="modal-box">
                    <form action="{{ route('alternatif.import') }}" method="post" enctype="multipart/form-data">
                        <h3 class="font-bold text-lg">Import Data Karyawan</h3>
                            @csrf
                            <div class="form-control w-full max-w-xs">
                                <label class="label">
                        ...
                        <div class="modal-action">
                            ...
                            <label for="import_button" class="btn">Cancel</label>
                        </div>
                    </form>
                </div>
