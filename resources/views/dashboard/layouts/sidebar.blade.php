...
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="ml-6 flex items-center text-lg font-bold text-gray-800 dark:text-gray-200 font-lexend" href="{{ route('dashboard') }}">
            <!-- Logo -->
            <img src="{{ asset('img/atl.png') }}" alt="Logo" class="w-10 h-8 mr-4">
            <!-- Nama PT -->
            <span>PT. Agung Tirta Lestari</span>
        </a>
        <ul class="mt-6">
        ...
        <ul>
            ...
            <li class="w-full mt-6">
                <h6 class="pl-6 font-bold leading-tight uppercase text-xs opacity-60">Menu Utama</h6>
            </li>
            ...
            <li class="relative px-6 pt-3">
                ...
                <a class="{{ Request::is('dashboard/kriteria/perhitungan_utama*') ? 'font-semibold text-purple-600 dark:text-purple-300' : 'text-gray-500 dark:text-gray-100' }} inline-flex items-center w-full text-sm transition-colors duration-150 hover:text-purple-600 dark:hover:text-purple-300" href="{{ route('perhitungan_utama') }}">
                    <i class="ri-table-line text-lg"></i>
                    <span class="ml-4">Metode AHP</span>
                </a>
            </li>
            <li class="relative px-6 pt-3">
            ...
            {{-- Data AHP --}}
            <li class="w-full mt-6">
                <h6 class="pl-6 font-bold leading-tight uppercase text-xs opacity-60">PENILAIAN KINERJA</h6>
            </li>
            <li class="relative px-6 pt-3">
