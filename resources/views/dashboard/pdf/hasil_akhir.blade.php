...
@section("container")
    <div class="container mx-auto grid px-6">
        <h1 class="judul-laporan my-10 text-2xl font-poppins text-gray-700 dark:text-gray-200">
            {{ $judul }}
        </h1>
    </div>
                        ...
                        <tbody>
                            @foreach ($hasil as $item)
                                <tr class="border-b dark:border-gray-700">
                                    <td class="px-4 py-3 text-gray-700 dark:text-gray-400 uppercase font-poppins">
