                    ...
                    <div class="overflow-x-auto p-3">
                        <table id="tabel_data" class="w-full text-sm text-left text-gray-500 dark:text-gray-400 stripe hover" style="width:100%; padding-top: 1em; padding-bottom: 1em;">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-4 py-3">Kode Kriteria</th>
                    ...
                    <form action="{{ route('kriteria.simpan') }}" method="post" enctype="multipart/form-data">
                        <h3 class="font-bold text-lg">Tambah Kriteria</h3>
                            ...
                            <div class="form-control w-full max-w-xs">
                                <label class="label">
                                    <span class="label-text">Kode Kriteria</span>
                                </label>
            ...
            <div class="modal">
                <div class="modal-box" id="edit_form">
                    <form action="{{ route('kriteria.perbarui') }}" method="post" enctype="multipart/form-data">
                        <h3 class="font-bold text-lg">Ubah KriteriaKriteria: <span class="text-greenPrimary" id="title_form"><span class="loading loading-dots loading-md"></span></span></h3>
                            @csrf
            ...
            <div class="modal">
                <div class="modal-box">
                    <form action="{{ route('kriteria.import') }}" method="post" enctype="multipart/form-data">
                        <h3 class="font-bold text-lg">Import Kriteria</h3>
                            @csrf
                            <div class="form-control w-full max-w-xs">
                                <label class="label">
