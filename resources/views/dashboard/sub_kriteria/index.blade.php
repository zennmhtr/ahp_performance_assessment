                        ...
                        @foreach ($data as $item)
                            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden mb-10">
                                ...
                                <div class="overflow-x-auto p-3">
                                    <table id="{{ 'tabel_data_' . $item['kriteria_id'] }}" class="w-full text-sm text-left text-gray-500 dark:text-gray-400 stripe hover" style="width:100%; padding-top: 0.5px; padding-bottom: 0.5px;">
            ...
            <div class="modal">
                <div class="modal-box">
                    <form action="{{ route('sub_kriteria.simpan') }}" method="post" enctype="multipart/form-data">
                        <h3 class="font-bold text-lg">Tambah Sub Kriteria <span class="text-purple-600" id="title_add_button"></span></h3>
                            @csrf
            ...
            <div class="modal">
                <div class="modal-box" id="edit_form">
                    <form action="{{ route('sub_kriteria.perbarui') }}" method="post" enctype="multipart/form-data">
                        <h3 class="font-bold text-lg">Ubah Sub Kriteria: <span class="text-purple-600 dark:text-purple-300" id="title_form"><span class="loading loading-dots loading-md"></span></span></h3>
                            @csrf
