            ...
            <div class="modal">
                <div class="modal-box" id="edit_form">
                    <form action="{{ route('kategori.perbarui') }}" method="post" enctype="multipart/form-data">
                        <h3 class="font-bold text-lg">Ubah Kategori: <span class="text-greenPrimary" id="title_form"><span class="loading loading-dots loading-md"></span></span></h3>
                            @csrf
            ...
            <div class="modal">
                <div class="modal-box">
                    <form action="{{ route('kategori.import') }}" method="post" enctype="multipart/form-data">
                        <h3 class="font-bold text-lg">Import Kategori</h3>
                            @csrf
                            <div class="form-control w-full max-w-xs">
                                <label class="label">
